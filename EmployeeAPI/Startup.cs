...
using EmployeeApi.DataAccess.Employee.Repositories;
using EmployeeAPI.Core.Employee.Business;
...
namespace EmployeeAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IConnectionFactory, ConnectionFactory>(x => new ConnectionFactory(Environment.GetEnvironmentVariable("CONNECTION_STRING")));
